            ...
            {open && (
                <motion.div
                    ...
                    <motion.div
                        ref={modalRef}
                        className={cn(
                            "md:min-h-[40%] lg:max-h-[90%] md:max-w-[70%] lg:max-w-[60%] bg-white text-black border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
                            className
                        )}
                        initial={{
                            opacity: 0,
